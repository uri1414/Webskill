// app/dashboard/staff/requests/page.tsx — Screen 2: Staff Request Queue.
// Read-only list of the org's open requests, oldest first. RLS scopes to the
// org + staff; the layout guard (requireCapability) gates the whole subtree.
