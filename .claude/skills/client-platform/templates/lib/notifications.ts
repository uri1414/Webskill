// ============================================================================
// notifications.ts — the delivery seam (#14).
//
...
// happened and links into the authenticated portal. See UI-Guidelines.md.
//
// Delivery for OTHER recipients / system events runs server-side as staff or
// via the service-role client (see lib/supabase/admin). RLS on `notifications`
// only lets staff create rows for arbitrary recipients.
// ============================================================================
...
// Registry. Add a Baseline-managed email adapter and an sms adapter here later;
// no caller changes. Until an adapter exists for a channel, the row is logged
// and delivery is treated as deferred (status stays `pending`).
