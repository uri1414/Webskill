...
// history, "Services provided" / "Services you could offer", plus the client
...
export default async function ClientProfile({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {!isBusiness && (
        <form action={addBusinessAction} className="mt-6 rounded-xl border border-line bg-white p-4">
          ...
          <button type="submit" className="mt-3 rounded-lg border border-line-strong px-3 py-2 text-sm font-semibold text-ink transition hover:bg-surface-soft">
            Add business
          </button>
        </form>
      )}
